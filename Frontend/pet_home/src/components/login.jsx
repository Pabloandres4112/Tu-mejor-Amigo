        ...
        <div className="absolute inset-0 flex flex-col items-center justify-end">
          <form onSubmit={handleSubmit} className="mt-60 space-y-8 px-2 py-8 text-center sm:mt-40 sm:px-4 sm:py-6">
            <div className="group relative">
              ...
              />
              <label htmlFor="username" className="absolute left-2 top-0 flex h-full transform items-center pl-2 text-base transition-all duration-300 group-focus-within:-top-7 group-focus-within:h-1/2 group-focus-within:pl-0 group-focus-within:text-base group-focus-within:text-white peer-valid:-top-7 peer-valid:h-1/2 peer-valid:pl-0 peer-valid:text-base peer-valid:text-white">Correo Electrónico</label>
            </div>
            ...
            <button type="submit" className="h-12 w-full rounded-3xl bg-blue-900 text-white transition-all duration-300 hover:bg-blue-800 sm:h-11 sm:px-5">Login</button>
          </form>
        </div>
      </div>
    </div>
